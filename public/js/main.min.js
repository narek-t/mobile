...
Rotate:RotateRecognizer,Press:PressRecognizer,on:addEventListeners,off:removeEventListeners,each:each,merge:merge,extend:extend,assign:assign,inherit:inherit,bindFn:bindFn,prefixed:prefixed});var freeGlobal="undefined"!=typeof window?window:"undefined"!=typeof self?self:{};freeGlobal.Hammer=Hammer,"function"==typeof define&&define.amd?define(function(){return Hammer}):"undefined"!=typeof module&&module.exports?module.exports=Hammer:window[exportName]=Hammer}(window,document,"Hammer"),$(document).ready(function(){function removeVisibility(){$(".main-nav").removeClass("visible"),$("button.main-nav__btn").removeClass("active"),$(".shadow").removeClass("visible"),$(".all-wrapper").removeClass("overflow-hidden")}$(".shadow").click(function(){removeVisibility()}),$("button.main-nav__btn").click(function(){$(this).hasClass("active")?removeVisibility():($(this).addClass("active"),$(".main-nav").addClass("visible"),$(".shadow").addClass("visible"),$(".all-wrapper").addClass("overflow-hidden"))});var myMenu=document.getElementById("main-nav"),mc=new Hammer(myMenu);mc.on("swipeleft",function(ev){removeVisibility()}),$("button.search__btn").click(function(){$(this).hasClass("active")?($(this).removeClass("active"),$(".search__layout").removeClass("visible"),$(".all-wrapper").removeClass("overflow-hidden")):($(this).addClass("active"),$(".search__layout").addClass("visible"),$(".all-wrapper").addClass("overflow-hidden"))}),document.addEventListener("touchmove",function(event){-1==event.target.parentNode.className.indexOf("noBounce")&&-1==event.target.className.indexOf("noBounce")||event.preventDefault()},!1)});