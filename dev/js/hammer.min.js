...
(function(window, document, exportName, undefined) {
  ...
  Input.prototype = {
    ...
    init: function() {
      ...
      this.evTarget && addEventListeners(this.target, this.evTarget, this
        .domHandler);
  ...
  function computeInputData(manager, input) {
    ...
    input.maxPointers = !session.prevInput ? input.pointers.length : ((input.pointers
        .length >
        session.prevInput.maxPointers) ? input.pointers.length : session.prevInput
      .maxPointers);
    ...
    off: function(events, handler) {
      ...
      each(splitStr(events), function(event) {
        if (!handler) {
          ...
          handlers[event] && handlers[event].splice(inArray(handlers[
            event], handler), 1);
        }
      });
      return this;
  ...
  var freeGlobal = (typeof window !== 'undefined' ? window : (typeof self !==
    'undefined' ? self : {})); // jshint ignore:line
